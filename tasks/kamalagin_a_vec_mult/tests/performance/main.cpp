...
class KamalaginAVecMultRunPerfTestProcesses
...
TEST_P(KamalaginAVecMultRunPerfTestProcesses, RunPerfModes) { ExecuteTest(GetParam()); }

const auto kAllPerfTasks =
    ppc::util::MakeAllPerfTasks<InType, KamalaginAVecMultMPI, KamalaginAVecMultSEQ>(
        PPC_SETTINGS_kamalagin_a_vec_mult);

const auto kGtestValues = ppc::util::TupleToGTestValues(kAllPerfTasks);

const auto kPerfTestName = KamalaginAVecMultRunPerfTestProcesses::CustomPerfTestName;

INSTANTIATE_TEST_SUITE_P(RunModeTests, KamalaginAVecMultRunPerfTestProcesses, kGtestValues,
                         kPerfTestName);
